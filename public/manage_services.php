    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .sidebar a {
            ...
            padding: 10px 12px; border-radius: 8px; margin-bottom: 6px; font-size: 0.9rem;
        }
        ...
        input, textarea {
            ...
            background: rgba(255,255,255,0.08); color: white; box-sizing: border-box;
        }
        button {
            background: rgba(52,120,246,0.4); color: white;
            border: 1px solid rgba(173,216,255,0.4); padding: 8px 18px;
